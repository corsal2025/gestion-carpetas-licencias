...
/// <summary>In-memory fake covering Insert/FindByRut/GetAll — what Casos' OnPostSave needs to
/// auto-create an F8 Urgentes row when "NO EXISTE CARPETA" is chosen. Everything else throws on
/// purpose: if a future change starts calling another member, this fake should fail loudly
/// instead of silently returning a default that hides the gap.</summary>
